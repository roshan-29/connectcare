...
<form>
    <button type="submit"  formaction="animals.php" style="margin:15px;height: 30px;width: 100px;cursor:pointer;
border: 3px solid white;background-color: grey;color:#f2f2f2;font-size:17px;">Back</button>
</form> 
<form method="post" action="animalsupdate.php">  
<fieldset>
<input type="text" name="id" placeholder=" Enter pet_id" style="width:100%;height:30px;
   border: 2px solid  white; border-radius:3px;background:transparent;" required  >
    <br><br>
  ...
  <input type="number" step=any name="weight"  placeholder="Enter weight" style="width:280px;height:30px;
   border: 2px solid  white; border-radius:3px;background:transparent;" min="1" required  >
  
 <input type="number" step=any name="height"  placeholder="Enter height" style="width:300px;height:30px;
   border: 2px solid  white; border-radius:3px;background:transparent;" min="15" required >
  <br><br>
  ...
  <input type="number" name="cost"  placeholder="Enter cost" style="width:100%;height:30px;
   border: 2px solid  white; border-radius:3px;background:transparent;" min="0"  required >
  <br><br>
  <input type="submit" name="submit" value="update" style="width:100%;height:30px;
   border: 3px solid  white; border-radius:3px;cursor:pointer;background-color: green" >&ensp; 
  </fieldset>
</form>
